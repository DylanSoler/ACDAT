...
//@GeneratedValue
    ...
    public RegaloParaCriaturitaConRegalos(int id, String denominacion, int ancho, int largo, int alto, char tipo, int edadMinima, BigDecimal precio, CriaturitaConRegalos propietario) 
    {
        this.id = id;
