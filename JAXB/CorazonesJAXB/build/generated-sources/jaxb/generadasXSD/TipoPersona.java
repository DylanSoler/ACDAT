...
public class TipoPersona implements Comparable<TipoPersona>{
    ...
    public String toStringBueno(){
        ...
        */
        ...
        s=""+this.getID()+", "+this.getNombre()+", "+this.getSexo()+", "+this.getSexoBuscado()+", "+this.getFechaNacimiento()+", "+this.getIngresos()+".";
    ...
    @Override
    public int compareTo(TipoPersona p) {
